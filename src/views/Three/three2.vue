...
<script lang='ts' setup>
  ...
  import {Scene, PerspectiveCamera, WebGLRenderer, BoxGeometry, MeshBasicMaterial, Mesh,Color,MeshStandardMaterial,DirectionalLight,AmbientLight,HemisphereLight} from 'three'
